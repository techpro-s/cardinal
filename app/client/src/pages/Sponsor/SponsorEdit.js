...
class SponsorEdit extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            imageUrl: props.sponsor.imageUrl
        };
    ...
    handleDelete=(event) =>{
        ...
        axios.delete(SERVER_URL+'sponsor/delete/'+id).then(function(response) {
            ...
            ReactDOM.render(deleted,
                document.getElementById('sponsor'+id)
            );
    ...
    handleSubmit = (event) => {
        ...
        axios.put(SERVER_URL + 'sponsor/update', {id:id,
            name: name,
            imageUrl: imageUrl
    ...
    render() {
        return (<div>
            <div id={'sponsor'+this.props.sponsor.id}>


                <div  className="col-xs-12 col-md-6">
                    <Row id={'alertRow'+this.props.sponsor.id} />
                    <Col md={3} xs={3}>
                        <Col >
                        <Image src={this.props.sponsor.imageUrl} className="imageSponsor " responsive/>
                    </Col>
                        <Col >
                            <Form horizontal onSubmit={this.handleDelete}>
                    <FormGroup controlId="formHorizontalId" hidden>
                        <FormControl placeholder='id' defaultValue={this.props.sponsor.id} required/>
                    </FormGroup>
                            ...
                            <Col md={8} xs={9}>
                                <Row>
                                    <FormGroup controlId="formHorizontalName">
                                        ...
                                        <Col md={7} xs={8}>
                                            <FormControl defaultValue={this.props.sponsor.name} placeholder='name' required
                                ...
                                <Row>
                                    <FormGroup controlId="formHorizontalImageUrl">
                                        ...
                                        <Col md={7} xs={8}>
                                            <FormControl defaultValue={this.props.sponsor.imageUrl} placeholder='imageUrl'
